...
public class ESHomeListEventsAdapter extends RecyclerView.Adapter<ESHomeListEventsAdapter.ContentHolder> {
    ...
    public static class ContentHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public void bindContent(HashMap<String, Object> item, Context context) {
            this.item = item;
    ...
    public ESHomeListEventsAdapter(ArrayList<HashMap<String,Object>> items, Context context){
        this.items = items;
    ...
    public void onBindViewHolder(ESHomeListEventsAdapter.ContentHolder holder, int position) {
        holder.bindContent(items.get(position), context);
